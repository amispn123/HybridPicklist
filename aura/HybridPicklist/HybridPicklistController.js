({	
    ...
    handleOptionSelect : function(component, event, helper) {
       var selcetedOption = event.getParam("selectedOption");
	   component.set("v.selectedOption" , selcetedOption); 
    ...
    onfocus : function(component, event, helper) {
        ...
        var getInputkeyWord = '';
        helper.filterHelper(component,event,getInputkeyWord);
    },
    ...
    keyPressController : function(component, event, helper) {
        ...
        var allRecords = component.get("v.AllOptions");
        ...
        if( getInputkeyWord.length > 0 ){
            ...
            component.set("v.visileOptions",  allOptions); 
            var forclose = component.find("searchRes");
            $A.util.addClass(forclose, 'slds-is-close');
            $A.util.removeClass(forclose, 'slds-is-open');
        }
